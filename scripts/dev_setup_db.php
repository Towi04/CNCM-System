...
$fns = [
    ...
    'grupo_fusion_ensure_schema', 'grupo_division_ensure_schema', 'alumno_plantel_transfer_ensure_schema',
    'tutor_ensure_schema', 'aula_ensure_schema', 'rol_aula_ensure_schema',
